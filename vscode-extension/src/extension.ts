...
class NovaChatProvider implements vscode.WebviewViewProvider {
...
`;
                    ...
                    if (!response.ok) {
                        throw new Error(
                            `Nova server returned ${response.status}`
                        );
                    }
    ...
    private async getProjectManifest(): Promise<string> {
...
export function activate(
    ...
    console.log(
        "Nova VS Code extension activated."
    );
}
